...
export async function sendUserResultsEmail(data: UserResultsEmailData): Promise<void> {
  ...
  const subject = `Your MSP Channel Readiness Scorecard`;
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; color: #111; background: #fff; margin: 0; padding: 0;">
  <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 520px; margin: 40px auto; padding: 0 20px;">
    <tr><td>
      <p style="font-size: 11px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.08em; color: #888; margin: 0 0 16px;">Untapped Channel Strategy</p>
      <h1 style="font-size: 20px; font-weight: 700; margin: 0 0 8px; color: #111;">Your scorecard is ready, ${data.firstName}.</h1>
      <p style="font-size: 14px; color: #555; margin: 0 0 28px; line-height: 1.6;">Your MSP Channel Readiness Assessment is complete. Here is what you scored.</p>

      <table cellpadding="0" cellspacing="0" style="width: 100%; border-top: 1px solid #e5e5e5;">
        <tr>
          <td style="padding: 12px 0; border-bottom: 1px solid #e5e5e5; font-size: 13px; color: #888; width: 120px;">Maturity Tier</td>
          <td style="padding: 12px 0; border-bottom: 1px solid #e5e5e5; font-size: 13px; font-weight: 600; color: #111;">${data.maturityLabel}</td>
        </tr>
        <tr>
          <td style="padding: 12px 0; font-size: 13px; color: #888;">Overall Score</td>
          <td style="padding: 12px 0; font-size: 13px; font-weight: 600; color: #111;">${data.overallScore} / 100</td>
        </tr>
      </table>
      ...
      <table cellpadding="0" cellspacing="0" style="margin-top: 28px;">
        <tr>
          <td>
            <a href="${resultsUrl}" style="display: inline-block; background: #111; color: #fff; font-size: 13px; font-weight: 600; text-decoration: none; padding: 12px 20px; border-radius: 6px;">View Your Full Scorecard</a>
          </td>
        </tr>
      </table>

      <p style="font-size: 12px; color: #999; margin: 32px 0 0; line-height: 1.6;">Your personalized analysis and priority focus are waiting for you on the scorecard page. If you have questions or want to talk through the results, reply to this email.</p>
      <p style="font-size: 12px; color: #999; margin: 12px 0 0;">Jon Purcell<br>Untapped Channel Strategy</p>
    </td></tr>
  </table>
</body>
</html>`;
  ...
  const text = [
    ...
    ``,
    `If you have questions or want to talk through the results, reply to this email.`,
    ``,
    `Jon Purcell`,
