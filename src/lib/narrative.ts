...
export interface NarrativeOutput {
  ...
  /** Set to true only when content was generated by Claude (not a fallback template). */
...
/** Type guard for DB/stored JSON that may be NarrativeOutput. Only returns true for AI-generated content (not fallback templates). */
