...
export default function AssessmentPage() {
    ...
    return (
      <AssessmentLayout>
        <div style={{ display: "flex", minHeight: "60vh", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 20, textAlign: "center" }}>
          ...
          <p style={{ fontSize: 15, fontWeight: 500, color: "#ffffff" }}>Building your scorecard...</p>
        </div>
      </AssessmentLayout>
    )
  }
  ...
  return (
    <AssessmentLayout>
      ...
      <div
        className="md:hidden"
        style={{ position: "fixed", top: 0, left: 0, right: 0, height: 3, zIndex: 9, background: "#2a2a2a" }}
      >
      ...
      {/* Questions — only render up to currentQ */}
      <div style={{ width: "100%" }}>
        {QUESTIONS.slice(0, currentQ + 1).map((question, qi) => {
          ...
          return (
            ...
            {/* Get My Results — shown below last question once answered */}
            {isLast && isComplete && (
      ...
      {/* Lead capture — appears below questions when Get My Results is clicked */}
      {step === "lead_capture" && (
        <div
          ref={leadCaptureRef}
          style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "80px 0 60px" }}
        >
